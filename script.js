...
let blogName = "Bouba Kinky";
let authorName = "Anne L.";
...
let footerHTML = "<hr><p>" + blogName + " is written by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and hosted by <a href='https://nekoweb.org/'>Nekoweb!</a></p>";
